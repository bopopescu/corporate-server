...
class DockerActionMixin(object):
	...
	def _start_docker_image(self, app, hostdn, password, args):
		...
		for var in ['nameserver.*', 'repository/online/server', 'repository/app_center/server', 'update/secure_apt', 'appcenter/index/verify', 'ldap/base', 'ldap/server.*', 'ldap/main.*', 'locale.*', 'domainname']:
