...
def find_hosts_for_main_packages():
	...
	try:
		...
		local_is_main = ucr_get('server/role') == 'domaincontroller_main'
		hosts.remove((local_fqdn, local_is_main))
	except ValueError:
		# not in list
		pass
	return hosts
